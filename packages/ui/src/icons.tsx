// Inline SVG icons (lucide-compatible props). Ported from docs/ui-blueprint icons.jsx.
...
export function AtSign(p: IconProps) {
  return (
    <Svg {...p}>
...
export function Smile(p: IconProps) {
  return (
    <Svg {...p}>
      <circle cx="12" cy="12" r="10" />
...
export function Code2(p: IconProps) {
  return (
    <Svg {...p}>
...
export function GitPullRequest(p: IconProps) {
  return (
    <Svg {...p}>
