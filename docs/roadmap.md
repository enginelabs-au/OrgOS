...
| 10 | Expand company operations | `docs/plans/phase_5_company_operations_plan.md` | R3 (`accepted`) | not started — generate only after G5 (this row is the next plan name, not a generated file) |
