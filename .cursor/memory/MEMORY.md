...
- Usage measurement (Growth GM-1…12): first-party, in-tenant, identifier/enum payloads only; every threshold without data is labelled `first-baseline`. D-35 trial rate card (Free/Pro/Max/Enterprise) is published; charges stay off (`ENGINE_BILLING_CHARGES_ENABLED=0`).
- Initial development is closed (Phases 0–7). Remaining owner walk is `docs/handover/outstanding-tasks.md` plus `docs/plans/final_implementation_checklist.md`. No Phase 8. Erasure records intent only. ERA-15 dry-run is list-only. `main` is on origin (`63a3e3a`). Local OQ-G2 recorded 2026-09-12T15:20Z. D-25 write/external Hermes remains unauthorized. OT-07…OT-14 are parked in `docs/handover/future-tasks.md`.
...
- Final closeout checklist (R1–R4): `docs/plans/final_implementation_checklist.md`
...
- Phase 6 plan (complete; G9 PASS): `docs/plans/phase_6_commercial_delivery_plan.md`
- Phase 6 planning authorized (D-33): `docs/decisions/2026-09-12-phase-6-planning-authorized.md`
- Phase 7 plan (complete; G11 PASS): `docs/plans/phase_7_ecosystem_mobile_plan.md`
- Phase 7 planning authorized (D-34): `docs/decisions/2026-09-12-phase-7-planning-authorized.md`
- Trial rate card (D-35): `docs/decisions/2026-09-13-trial-rate-card.md`
...
- Live outstanding task list (repeat every turn): `docs/handover/outstanding-tasks.md`
- Parked later work: `docs/handover/future-tasks.md`
