...
- Method: Document inspection; cross-check of `docs/capabilities.md` `required_grants` column against PRD-D and against `docs/blueprints/ui-blueprint.md` §B seat visibility rows.
- Result — gaps:
