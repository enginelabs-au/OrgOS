      ...
      >
        <div style={{ height: isMobile ? 52 : 60, display: "flex", alignItems: "center", padding: isMobile ? "0 10px" : "0 16px", gap: isMobile ? 8 : 16 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", flexShrink: 0 }}>
            <span style={{ color: T.t1, fontSize: isMobile ? 13 : 15, fontWeight: 700, letterSpacing: "-0.01em", fontFamily: F.mono }}>OrgOS</span>
          </div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 4, flexShrink: 0 }}>
            ...
            <button
              type="button"
              title={globalAgentOpen ? "Close Hey Engine" : "Hey Engine"}
              onClick={(e) => {
                e.stopPropagation();
